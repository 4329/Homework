...
void RobotMap::init() {
    ...
    driveTrainLeftFrontMotor.reset(new CANTalon(LEFT_FRONT_CAN));
    lw->AddActuator("DriveTrain", "LeftFrontMotor", driveTrainLeftFrontMotor);
    
    driveTrainLeftRearMotor.reset(new CANTalon(LEFT_REAR_CAN));
    lw->AddActuator("DriveTrain", "LeftRearMotor", driveTrainLeftRearMotor);
    
    driveTrainRightFrontMotor.reset(new CANTalon(RIGHT_FRONT_CAN));
    lw->AddActuator("DriveTrain", "RightFrontMotor", driveTrainRightFrontMotor);
    
    driveTrainRightRearMotor.reset(new CANTalon(RIGHT_REAR_CAN));
